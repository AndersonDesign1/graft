...
```sh
pnpm add @usegraft/sdk-tanstack-start @usegraft/auth @usegraft/mcp
```
...
```sh
npm i @usegraft/sdk-tanstack-start @usegraft/auth @usegraft/mcp
```
...
```sh
bun add @usegraft/sdk-tanstack-start @usegraft/auth @usegraft/mcp
```
