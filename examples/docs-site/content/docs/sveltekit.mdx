...
```sh
pnpm add @usegraft/sdk-sveltekit @usegraft/auth @usegraft/mcp
```
...
```sh
npm i @usegraft/sdk-sveltekit @usegraft/auth @usegraft/mcp
```
...
```sh
bun add @usegraft/sdk-sveltekit @usegraft/auth @usegraft/mcp
```
